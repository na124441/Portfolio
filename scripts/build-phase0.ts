...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Loops', 'Iteration', 'Basic Syntax'],
    difficulty: 'Warm-up',
    order: 4,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Loops', 'Basic Syntax', 'Formatting'],
    difficulty: 'Warm-up',
    order: 9,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Math', 'Fibonacci', 'Dynamic Programming', 'Loops'],
    difficulty: 'Warm-up',
    order: 10,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Arrays', 'Hashing', 'Sorting', 'Duplicates'],
    difficulty: 'Warm-up',
    order: 13,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Complexity Analysis', 'Math', 'Loops'],
    difficulty: 'Warm-up',
    order: 14,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['OOP', 'Classes', 'Conditions', 'Records'],
    difficulty: 'Warm-up',
    order: 16,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['OOP', 'Geometry', 'Classes', 'Math'],
    difficulty: 'Warm-up',
    order: 17,
    statement: `### Problem Description
...
if __name__ == '__main__':
  ...
  },
  {
    ...
    topic: 'Syntax, loops, conditions, functions, and pseudocode',
    tags: ['Arrays', 'Loops', 'Math', 'Filtering'],
    difficulty: 'Warm-up',
    order: 18,
    statement: `### Problem Description
...
// Write out to phase0.ts
const targetFile = path.resolve(__dirname, '../src/data/bytelogic/dsa/phases/phase0.ts');
const fileContent = `import type { DsaProblem } from '@/types/dsa-question';

export const PHASE_0_PROBLEMS: DsaProblem[] = ${JSON.stringify(REFINED_PHASE_0, null, 2)};
`;

fs.writeFileSync(targetFile, fileContent, 'utf-8');
console.log(`Successfully generated and wrote ${REFINED_PHASE_0.length} refined problems to ${targetFile}`);
